...
const groups = [
  ...
  { label: "Operación", links: [["⌁", "Sucursales", "/admin/branches"], ["↗", "Ventas", "/admin/sales"], ["$", "Rendiciones", "/admin/settlements"], ["□", "Stock", "/admin/stock"], ["⊞", "Stock por sucursal", "/admin/branch-stock"], ["⇧", "Reposición", "/admin/replenishment"], ["✂", "Desposte", "/admin/production"], ["⇄", "Distribución", "/admin/transfers"]] },

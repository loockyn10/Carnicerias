...
export default async function CatalogPage() {
  ...
  return <main className="mx-auto max-w-7xl p-5 sm:p-10">
    ...
    <section className="mt-7 rounded-2xl border bg-white p-5 shadow-sm"><h2 className="text-xl font-black">Productos</h2>
    ...
    <section className="mt-7 rounded-2xl border bg-white p-5 shadow-sm"><h2 className="text-xl font-black">Nuevo precio</h2><p className="mt-1 text-sm text-stone-600">Sin sucursal = precio global. Un precio de sucursal tiene prioridad mientras esté vigente.</p>

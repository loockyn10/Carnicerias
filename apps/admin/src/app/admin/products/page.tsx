...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const [categoriesResult, productsResult, pricesResult, discountsResult, costsResult, cashResult] = await Promise.all([
  ...
  const error = [categoriesResult.error, productsResult.error, pricesResult.error, discountsResult.error, costsResult.error, cashResult.error].find(Boolean);
